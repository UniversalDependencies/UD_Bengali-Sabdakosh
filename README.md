...
As of the time of writing (2025-04-19) the treebank passes level 3 of Universal Dependencies validation. Final work on documentation and annotation checks are pending before the data can be included in the Universal Dependencies release.
